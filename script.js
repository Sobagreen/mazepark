const INITIAL_LAYOUT = [
  ...
  ["3З1", "П", "5З2", "П", "Т1", "Т1", "П", "4З1", "П", "6З2"],
  ["5З1", "П", "3З2", "П", "Т2", "Т2", "П", "6З1", "П", "4З2"],
...
const TOKEN_MAP = {
  ...
  "1З1": { type: "mirror", player: "light", orientation: 1 },
  "2З1": { type: "mirror", player: "light", orientation: 3 },
  "3З1": { type: "mirror", player: "light", orientation: 2 },
  "4З1": { type: "mirror", player: "light", orientation: 1 },
  "5З1": { type: "mirror", player: "light", orientation: 3 },
  "6З1": { type: "mirror", player: "light", orientation: 3 },
  "7З1": { type: "mirror", player: "light", orientation: 0 },
  "1З2": { type: "mirror", player: "light", orientation: 1 },
  "2З2": { type: "mirror", player: "light", orientation: 2 },
  "3З2": { type: "mirror", player: "light", orientation: 3 },
  "4З2": { type: "mirror", player: "light", orientation: 0 },
  "5З2": { type: "mirror", player: "light", orientation: 1 },
  "6З2": { type: "mirror", player: "light", orientation: 2 },
  "7З2": { type: "mirror", player: "light", orientation: 1 },
  "1Щ1": { type: "shield", player: "light", orientation: 1 },
